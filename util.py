...
async def call_llm(prompt_to_send: str, is_meta_prompt: bool = True) -> str:
    ...
    if HIGH_SPEED_MODE:
        ...
        # Fallback to Ollama if Groq fails after retries
...
async def critic_evaluate(
    original_task: str, # MODIFIED TO MATCH AGENTS.PY AND PROVIDE CONTEXT
